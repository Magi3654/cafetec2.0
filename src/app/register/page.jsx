    ...
    return (
        <section className="mt-8">
            ...
            <form className="flex flex-col mx-20" onSubmit={handleFormSubmit}>
                ...
                <input type="email" placeholder="email" className="rounded-md bg-gray py-2 px-4 m-2" value={email} onChange={ev => setEmail(ev.target.value)}></input>

                <input type="password" placeholder="password" className="rounded-md bg-gray py-2 px-4 m-2" value={password} onChange={ev => setPassword(ev.target.value)}></input>
